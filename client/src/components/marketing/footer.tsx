...
const footerLinks = {
  services: [
    { href: "/services#managed", label: "Managed Websites" },
    { href: "/services#custom", label: "Custom Websites" },
    { href: "/services#stores", label: "Online Stores" },
    { href: "/services#apps", label: "Web Apps" },
  ],
  company: [
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16 lg:py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          <div className="lg:col-span-2">
            ...
            <p className="text-muted-foreground text-sm max-w-sm mb-6">
              Precision-built digital systems crafted with structure, 
              collaboration, and purpose. We transform ideas into 
        ...
        <div className="mt-16 pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-muted-foreground">
            {new Date().getFullYear()} HiveCraft Digital. All rights reserved.
          </p>
